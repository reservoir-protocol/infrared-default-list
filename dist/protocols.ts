export const protocols = [
  ...
  {
    description:
      'Unlocking Instant liquidity for Berachain assets through the first PoL powered stablecoin NECT.',
    id: 'beraborrow',
  ...
  {
    description:
      'An EVM-identical L1 aligning security and liquidity powered by Proof Of Liquidity',
    id: 'berachain',
  ...
  {
    description:
      'Dolomite is a lending and borrowing platform that can support over 1,000 unique assets.',
    id: 'dolomite',
  ...
  {
    description:
      'Infrared simplifies interacting with Proof of Liquidity with our liquid staking products.',
    id: 'infrared',
  ...
  {
    description:
      'Kodiak, is a vertically-integrated liquidity hub on Berachain',
    id: 'kodiak',
